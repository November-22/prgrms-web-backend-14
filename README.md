...
- 매주 목요일 오후 8시 30분에 라이브 세션으로 진행됩니다. 단, 매월 마지막 주차는 휴식합니다.
- 개인 발표로 진행되며 주차별 발표자는 사다리 타기로 결정합니다. 
- 발표 시간은 최대 30분이며 발표자료(노션/블로그/PPT 등)를 이용해 발표를 진행합니다.
- [발표 순서 선점하기](https://docs.google.com/spreadsheets/d/149ykvAOqwQyWR03rwm0aS3B4rE-E6QW9TZ6MwpDSbBY/edit?usp=sharing)
