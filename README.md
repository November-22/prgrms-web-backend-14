...
> 프로그래머스 웹 백엔드 구현 스터디(14기) 종료 후 리더(김건)의 제안으로 구성된 스터디 모임입니다.

## 📆 일정

- ~~기간: 2022.11.10 ~ 2023.03.02~~
- ~~매주 목요일 20시 30분에 디스코드로 진행합니다.~~
- 23.04 ~ -ing / 매주 금요일 20시 30분 디스코드 회의
...
|                  김 건(리더)                   |                 강민주|                   최지혜                   |
| :--------------------------------------: | :------------------------------------: | :------------------------------------: |
| [@kimgun95](https://github.com/kimgun95) | [@kkangmj](https://github.com/kkangmj) | [@hellooz19](https://github.com/hellooz19) | 
